...
const Logo = ({ className }: { className?: string }) => (
  <div className={`flex items-center gap-3 ${className}`}>
    <div className="relative w-12 h-12 flex items-center justify-center">
       ...
       <img 
         src="https://photos.fife.usercontent.google.com/pw/AP1GczO0raoIBOewikbCBq-eLnwuT4rETGBiFcwfSbE0842M6gEDG9V6IplO=w1678-h915-s-no-gm?authuser=0" 
         alt="CAREVIA" 
         className="relative z-10 w-full h-full object-contain"
         referrerPolicy="no-referrer"
         onError={(e) => {
           // Fallback to a clear placeholder if the Google Photos link fails (common due to auth)
           e.currentTarget.src = "https://img.icons8.com/isometric/512/shield.png";
         }}
       />
    </div>
