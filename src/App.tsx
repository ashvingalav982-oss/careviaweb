    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 font-sans">
      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex justify-between items-start mb-8">
            <div>
              <h2 className="text-2xl font-black uppercase tracking-widest text-primary flex items-center gap-3">
                ...
                {mode === 'login' ? 'Secure Login' : mode === 'signup' ? 'Create Access' : mode === 'mfa' ? 'Verify Identity' : mode === 'phone-login' || mode === 'phone-otp' ? 'Mobile Access' : 'Provider Access'}
              </h2>
          ...
          <div className="space-y-4">
            {mode === 'phone-login' || mode === 'phone-otp' ? (
              <div className="space-y-4">
                 {mode === 'phone-login' ? (
                   <div>
          ...
          {mode !== 'sp' && mode !== 'mfa' && mode !== 'phone-otp' && mode !== 'phone-login' && (
